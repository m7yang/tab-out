...
test('PageChip expands same-title URL variant groups in place', () => {
  ...
  assert.match(layoutFragmentsSource, /chip-title-variant-list inline-flex max-w-full flex-col items-stretch pr-\[5px\] pb-1 align-top divide-y divide-neutral-500\/15/)
  assert.match(layoutFragmentsSource, /chip-title-variant inline-flex max-w-full min-w-0 items-center gap-1 rounded-none bg-transparent px-1\.5 py-\[3px\]/)
