...
test('PageChip renders same-title URL variants below one visible title', () => {
  ...
  assert.match(requiredAt(titleVariantButtonMatch, 1), /rounded-md/)
...
test('PageChip expands same-title URL variant groups in place', () => {
  ...
  assert.match(layoutFragmentsSource, /chip-title-variant inline-flex max-w-full min-w-0 items-center gap-1 rounded-md bg-transparent px-1\.5 py-\[3px\]/)
