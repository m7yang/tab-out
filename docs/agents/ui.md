...
- Tall Page Chips and Domain Card outlines use the approved CSS `superellipse(1.7)` midpoint (ADR 0055); compact Page Chips keep the measured capsule. All four corners share one fixed radius per surface: 18.65px for tall chips and 38.5px for cards, independent of card contents. Preserve natural height, CSS radius overlap reduction, and existing spacing. Other non-capsule rectangles retain their existing shapes; do not introduce asymmetric or content-dependent card corners.
