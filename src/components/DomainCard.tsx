    ...
    <DomainCardProvider value={cardContext}>
      <div
        ...
        className={cn(
          ...
          "after:pointer-events-none after:absolute after:-inset-2 after:rounded-history-match-card after:border after:border-neutral-600/35 after:opacity-0 after:[corner-shape:superellipse(1.7)] after:content-[''] has-[.page-chip-hover-match,.page-chip-overflow-hover-match]:after:opacity-100",
