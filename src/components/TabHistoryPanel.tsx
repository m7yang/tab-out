  ...
  return (
    ...
    >
      ...
      >
        ...
        <div ref={historyContentRef} className="history-entry-list-content pointer-events-auto flex self-start w-65 min-w-0 flex-col gap-0 pt-3 pr-3.5 pb-10 max-[980px]:w-full max-[980px]:pr-0 max-[980px]:pb-3">
          {rows.map((row) => {
